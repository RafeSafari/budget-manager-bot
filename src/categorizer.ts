...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  Food: [
    ...
    'برنج', 'برو', 'ماکارونی', 'سالاد', 'سوپ', 'آش', 'حلیم',
  ...
  Bills: [
    ...
    'اینترنت', 'پهن‌ band', 'ADSL', 'وای‌ فای',
    'شارژ', 'شارژ موبایل', 'شارژ تلفن',
    'orent', 'اجاره', 'اجاره خونه', 'اجاره مسکن',
  ...
  Health: [
    ...
    'آزمایش', 'آزمایشگاه', 'آزمایشگاه',
    'رادیولوژی', 'سونوگرافی', 'ام‌ آر آی', 'سی‌ تی‌ اسکن',
    'فیزیوتراپی', 'کاردرمانی',
    'dentist', 'دندانپزشک', 'دندان', 'لمینت', 'کامپوزیت', 'ارتودنسی',
    'بینایی‌ سنجی', 'عینک طبی',
    'واکسن', 'واکسیناسیون',
    'vitamin', 'ویتامین', 'مکمل',
    'جراحی', 'عمل', 'بیهوشی',
    'اورژانس', 'امداد',
  ],
  Education: [
